...
.therichpost-border-pale-yellow,.therichpost-hover-border-pale-yellow:hover{border-color:#ffffcc!important}.therichpost-border-pale-blue,.therichpost-hover-border-pale-blue:hover{border-color:#e7ffff!important}
    ...
    <body class="therichpost-light-grey" style="background-size:cover; background-repeat:no-repeat" background="{{ asset('bakcground/bg.jpeg') }} ">
        <!-- Top container -->
<!-- Sidebar/menu -->
...
<h2>Gudang إيمان</h2>
  ...
  <div class="therichpost-bar-block">
    ...
    <a href="/data_barang" class="therichpost-bar-item therichpost-button therichpost-padding "><i class="fa fa-book"></i>  Data Barang</a>
    <a href="/data_toko" class="therichpost-bar-item therichpost-button therichpost-padding"><i class="fa fa-archive"></i>  Data Toko</a>
    <a href="/data_order" class="therichpost-bar-item therichpost-button therichpost-padding"><i class="fa fa-shopping-cart"></i>  Orderan</a>
    <a href="#" class="therichpost-bar-item therichpost-button therichpost-padding"><i class="fa fa-cog fa-fw"></i>  Settings</a><br><br>
  </div>
  @elsecan('isManager')
  <div class="therichpost-container">
    <h5>Dashboard Manager</h5>
  </div>
  <a href="/status" class="therichpost-bar-item therichpost-button therichpost-padding "><i class="fa fa-book"></i>  Status Orderan</a> <br>
  <a href="/laporan" class="therichpost-bar-item therichpost-button therichpost-padding "><i class="fa fa-book"></i>  Laporan</a>
  @endcan
</nav>
<!-- Overlay effect when opening sidebar on small screens -->
<div class="therichpost-overlay therichpost-hide-large therichpost-animate-opacity" onclick="therichpost_close()" style="cursor:pointer" title="close side menu" id="myOverlay">

</div>
<!-- !PAGE CONTENT! -->
<div class="therichpost-main" style="margin-left:300px;">
    <li class="nav-item dropdown float-end mx-5">
